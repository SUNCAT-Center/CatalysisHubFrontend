          ...
          <Plot
            data={[
              ...
              },
              {
                ...
                text: ['ArCl', 'BeGd', 'ArMo', 'CuNb', 'CoPm', 'LrCo', 'RbNp', 'SeSb', 'ZnSm', 'GdAt', 'LaLv', 'LrZn', 'RfNe', 'NoAl', 'HfGa', 'LaLu', 'TlSe', 'SgSn', 'NiLi', 'PU', 'ReSg', 'CaO', 'LaCf', 'LiFr', 'LvO', 'NoSn', 'FmAl', 'AmNo', 'OgTc', 'NoEs', 'LrSe', 'MdMn', 'PuRa', 'CsTm', 'RhHo', 'CuHg', 'TmTs', 'TiBr', 'CoNp', 'BeNi', 'LrMo', 'TsW', 'PoLi', 'KFl', 'FRh', 'BRf', 'XKr', 'OgCf', 'KGd', 'SiEs', 'CrAt', 'AgC', 'LrNp', 'GdPr', 'URf', 'GdOs', 'AcXe', 'BaSi', 'LrTa', 'RfAl', 'PoTb', 'TsOg', 'AcMo', 'MgCm', 'XMn', 'TmTb', 'PSn', 'CdW', 'XeNb', 'PPo', 'GaOs', 'TiIn', 'RaBh', 'FmBh', 'PaXe', 'VRf', 'EuFl', 'NeTm', 'PaNh', 'NbCl', 'RuNh', 'AsEr', 'KrTh', 'AmNe', 'MdV', 'NDy', 'BAc', 'CaRn', 'LiX', 'PbOs', 'BiS', 'BiSg', 'ArX', 'PuNe', 'ClPu', 'RfFr', 'NdRa', 'CnEs', 'SiHg', 'BiRh'],
                type: 'scatter',
                name: '',
              },
            ]}
