...
class TermAutosuggest extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  componentDidMount() {
    ...
    if (this.props.field === 'year') {
      query = '{systems { edges { node { PublicationYear } } }}';
      responseField = 'PublicationYear';
      parseField = false;
    } else if (this.props.field === 'formula') {
      query = '{systems { edges { node { Formula } } }}';
      responseField = 'Formula';
      parseField = false;
    }
