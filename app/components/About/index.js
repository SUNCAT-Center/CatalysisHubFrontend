...
class About extends React.Component { // eslint-disable-line react/prefer-stateless-function
  render() {
    ...
    const {
      paper, paragraph, publication, text, peopleList, bannerBox,
    } = classes;
    return (
      <div>
        ...
        <Paper className={paper}>
          ...
          <div className={publication}>
            ...
            <div> Kirsten T. Winther, Max J. Hoffmann, Jacob R. Boes, Osman Mamun, Michal Bajdich and Thomas Bligaard, </div>
            <div>
              <i> Scientific Data </i>
              <b>6</b>
              , Article number: 75 (2019)
            </div>
...
.
        ...
        <Paper className={paper}>
          ...
          >
            <Grid item lg={4} className={bannerBox}>
