...
// Load Libraries
  ...
  /*tfcanvas_${this.props.selectedSystem.uniqueId}.rotationMatrix = ChemDoodle.lib.mat4.rotate(tfcanvas_${this.props.selectedSystem.uniqueId}.rotationMatrix,(e.alpha -  alpha_${this.props.selectedSystem.uniqueId}) * 0.55, tfcanvas_${this.props.selectedSystem.uniqueId}.rotationMatrix.slice(0, 3));*/
  if(typeof beta_${this.props.selectedSystem.uniqueId} !== 'undefined') {
  tfcanvas_${this.props.selectedSystem.uniqueId}.rotationMatrix = ChemDoodle.lib.mat4.rotate(tfcanvas_${this.props.selectedSystem.uniqueId}.rotationMatrix,(e.beta -  beta_${this.props.selectedSystem.uniqueId}) * 0.55,  tfcanvas_${this.props.selectedSystem.uniqueId}.rotationMatrix.slice(8, 11));
  }
  if (typeof gamma_${this.props.selectedSystem.uniqueId} !== 'undefined') {
  tfcanvas_${this.props.selectedSystem.uniqueId}.rotationMatrix = ChemDoodle.lib.mat4.rotate(tfcanvas_${this.props.selectedSystem.uniqueId}.rotationMatrix,(e.gamma -  gamma_${this.props.selectedSystem.uniqueId}) * 0.55,  tfcanvas_${this.props.selectedSystem.uniqueId}.rotationMatrix.slice(4, 7));
  }
